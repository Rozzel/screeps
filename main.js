...
module.exports.loop = () => {
    ...
    units.spawning('Hatchery', 'droneUpgrader', 'upgrader', 6, [WORK, CARRY, CARRY, MOVE, MOVE, MOVE]);
    units.spawning('Hatchery', 'droneCarrier', 'carrier', 6, [MOVE, CARRY, MOVE, MOVE, MOVE]);
